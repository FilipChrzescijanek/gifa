...
import static pwr.chrzescijanek.filip.gifa.model.sample.BasicSample.SampleSelection.*;
...
public abstract class BasicSample extends Ellipse {
     ...
     */
    protected BasicSample(final ImageData imageData, double x, double y, double radiusX, double radiusY,
