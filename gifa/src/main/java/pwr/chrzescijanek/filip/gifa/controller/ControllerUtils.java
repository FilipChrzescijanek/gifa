...
final class ControllerUtils {
    ...
    static void prepareImage(BaseSample sample, int index, Mat[] images, SamplesImageData samplesImageData) {
    ...
    static void writeImage(File selectedDirectory, List<Pair<String, ImageView>> currentSamples, int i, int j) throws IOException {
    ...
    static File getFile(Window window) {
    ...
    static List<File> getFiles(Window window) {
        FileChooser fileChooser = new FileChooser();
    ...
    static File getDirectory(Window window) {
        DirectoryChooser chooser = new DirectoryChooser();
        chooser.setTitle("Choose directory");
        return chooser.showDialog(window);
    }

    static Alert getAboutDialog() {
    ...
    static Alert getErrorAlert(final String content) {
        return new Alert(Alert.AlertType.ERROR, content, ButtonType.OK);
    }

    static Stage initDialog(Window window) {
    ...
    static HBox getHBoxWithLabel(String info) {
    ...
    static void startRunnable(final Task<? extends Void> task) {
        Thread th = new Thread(task);
        th.setDaemon(true);
        th.start();
    }

    static String getWebColor(Color newValue) {
